...
Piece.prototype.draw = function ()
{
  if ((!this.moveble) && (!this.placed))
  {
    ...
    //this.game.context.clearRect(Math.round(this.startPoint.x-this.game.piece_width/2),
    // Math.round(this.startPoint.y-this.game.piece_height/2), this.game.piece_width, this.game.piece_height);
    // this.game.context.fillRect(Math.round(this.startPoint.x-this.game.piece_width/2),
    // Math.round(this.startPoint.y-this.game.piece_height/2), this.game.piece_width, this.game.piece_height);

    //this.game.context.drawImage(this.game.context_bg.getImageData(Math.round(this.startPoint.x-this.game.piece_width/2),
    // Math.round(this.startPoint.y-this.game.piece_height/2), this.game.piece_width, this.game.piece_height),
    // Math.round(this.startPoint.x-this.game.piece_width/2), Math.round(this.startPoint.y-this.game.piece_height/2),
    // this.game.piece_width, this.game.piece_height, Math.round(this.startPoint.x-this.game.piece_width/2),
    // Math.round(this.startPoint.y-this.game.piece_height/2), this.game.piece_width, this.game.piece_height );
    // this.game.context.putImageData(this.game.context_bg.getImageData(Math.round(this.startPoint.x-this.game.piece_width/2),
    // Math.round(this.startPoint.y-this.game.piece_height/2), this.game.piece_width, this.game.piece_height),
    // Math.round(this.startPoint.x-this.game.piece_width/2), Math.round(this.startPoint.y-this.game.piece_height/2));
